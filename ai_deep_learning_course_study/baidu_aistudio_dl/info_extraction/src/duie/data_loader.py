...
from src.duie.extract_chinese_and_punct import ChineseAndPunctuationExtractor
...
if __name__ == "__main__":
    ...
    data_dir = "/home/yckj2453/dataset/Info-Extract/duie"
    d = DuIEDataset.from_file(os.path.join(data_dir, "duie_sample.json"), tokenizer)
