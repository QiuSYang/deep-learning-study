...
class PreTrainedModel(nn.Module, ModuleUtilsMixin):
    ...
    def generate(
        ...
        input_images_length: Optional[torch.LongTensor] = None,
        input_image_indexes: Optional[torch.LongTensor] = None,
        ...
        **model_specific_kwargs
        ...
        if self.config.is_encoder_decoder:
            # create empty decoder_input_ids, 覆盖初始input_ids
            input_ids = torch.full(
