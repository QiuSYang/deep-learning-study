...
class FPN(tf.keras.Model):
    def __init__(self, out_channels=256, **kwargs):
        ...
        :param out_channels: int. the channels of pyramid feature maps.
        :param kwargs:
        """
        ...
        # network layers
        self.fpn_c2p2 = layers.Conv2D(self.out_channels, (1, 1),
                                      kernel_initializer='he_normal', name='fpn_c2p2')
        self.fpn_c3p3 = layers.Conv2D(self.out_channels, (1, 1),
                                      kernel_initializer='he_normal', name='fpn_c2p2')
        self.fpn_c4p4 = layers.Conv2D(self.out_channels, (1, 1),
                                      kernel_initializer='he_normal', name='fpn_c2p2')
        self.fpn_c5p5 = layers.Conv2D(self.out_channels, (1, 1),
                                      kernel_initializer='he_normal', name='fpn_c2p2')
        ...
        self.fpn_p2 = layers.Conv2D(self.out_channels, (3, 3), padding='SAME',
                                    kernel_initializer='he_normal', name='fpn_p2')
        self.fpn_p3 = layers.Conv2D(self.out_channels, (3, 3), padding='SAME',
                                    kernel_initializer='he_normal', name='fpn_p2')
        self.fpn_p4 = layers.Conv2D(self.out_channels, (3, 3), padding='SAME',
                                    kernel_initializer='he_normal', name='fpn_p2')
        self.fpn_p5 = layers.Conv2D(self.out_channels, (3, 3), padding='SAME',
                                    kernel_initializer='he_normal', name='fpn_p2')
        self.fpn_p6 = layers.MaxPooling2D(pool_size=(2, 2), strides=2, name='fpn_p6')

    def __call__(self, inputs, training=True):
        """
        # fpn  structure chart address:
        #    https://pic4.zhimg.com/80/v2-27fcd4a765c89bfb2e1d7c3bd243be13_720w.jpg
        :param inputs: resnet outputs
        :param training:
        :return:
        """
        C2, C3, C4, C5 = inputs
