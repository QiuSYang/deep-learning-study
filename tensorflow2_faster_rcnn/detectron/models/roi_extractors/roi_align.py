"""
# roi映射到feature map获取每个roi的特征图, 使用的方法是roi align.
# 将提取的
"""
...
class PyramidROIAlign(tf.keras.layers.Layer):
    ...
    def __call__(self, inputs, training=True):
        ...
        for i, level in enumerate(range(2, 6)):
            ...
            pooled_rois.append(tf.image.crop_and_resize(feature_map_list[i],
                                                        level_rois, level_roi_indices,
