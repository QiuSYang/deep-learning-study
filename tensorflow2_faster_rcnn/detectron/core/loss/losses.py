...
class RPNClassLoss(layers.Layer):
    def __init__(self):
        ...
        self.sparse_categorical_crossentropy = losses.SparseCategoricalCrossentropy(from_logits=True,
    ...
    def __call__(self, rpn_labels, rpn_class_logits, rpn_label_weights):
        ...
        # Calculate loss, 先进行softmax，再进行crossentropy,
        # 所以y_pred是未进行softmax的网络输出值
